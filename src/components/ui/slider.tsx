    ...
    >
      ...
      >
        <SliderPrimitive.Range
          ...
          className={cn(
            "bg-light-blue absolute data-[orientation=horizontal]:h-full data-[orientation=vertical]:w-full",
          )}
        />
      </SliderPrimitive.Track>
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          // biome-ignore lint/suspicious/noArrayIndexKey: Should be fine for now.
          key={index}
