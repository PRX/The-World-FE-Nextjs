...
import type { Program, Episode, Post, Segment } from "@/interfaces";
import { unstable_cache } from "next/cache";
import Image from "next/image";
import { isArray } from "lodash";
import CtaRegion from "@/app/(main)/_components/CtaRegion";
import { getCtaRegionMessages, getShownMessage } from "@/lib/cta";
import { type ProgramQueryOptions, fetchGqlPrograms } from "@/lib/fetch";
...
export default async function ProgramsPage({
  ...
  return (
    ...
    >
      {!!nodes?.length ? (
        nodes.map((p: Program, carouselIndex) => {
          const { id, name, link, count, taxonomyImages, contentNodes } = p;
          const { logo } = taxonomyImages || {};
        ...
        <Empty>
          <EmptyHeader>
            ...
            <EmptyTitle>No Program Found</EmptyTitle>
            <EmptyDescription>
              We do not have a program related to your search query.
            </EmptyDescription>
          </EmptyHeader>
        </Empty>
      )}
